...
(function () {
  ...
  const music = {
    ...
    volume: 0.7,
    tracks: [
      { id: 1, name: "Never Gonna Give You Up", file: "/audio/rr-mix.mp3" },
      { id: 2, name: "Baby, Baby",              file: "/audio/baby-baby.mp3" },
      { id: 3, name: "How Will I Know",         file: "/audio/how-will-i-know.mp3" },
      { id: 4, name: "Pump It Up",              file: "/audio/pump-it-up.mp3" },
      { id: 5, name: "Turn Down for What",      file: "/audio/turn-down-for-what.mp3" },
      { id: 6, name: "Peru",                    file: "/audio/peru.mp3" },
      { id: 7, name: "Gimme More",              file: "/audio/gimme-more.mp3" },
